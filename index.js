...
Events.prototype = {
    ...
    $plunge: function(e, args) {
        ...
        // Surface it
        if (this.$childEventEmitters) {
            for (var i = 0;i<this.$childEventEmitters.length;++i) {
                this.$childEventEmitters[i].$surface(e, args);
            }
        }
    ...
    $bubbling: function(e, args) {
        ...
        // Bubbling itself
        if (this.$parentEventEmmiter) {
            this.$parentEventEmmiter.$bubbling(e, args);
        }
